...
| **DamageOnTouchOneShot.cs** | **One-shot damage on touch**: extends Corgi **DamageOnTouch**. After dealing damage to a damageable target once, destroys this GameObject. Use for trap damage prefabs (e.g. **TrapZone** damage prefab) that should disappear after one hit. Menu: *Gameplay → Environment → Damage On Touch One Shot*. |
