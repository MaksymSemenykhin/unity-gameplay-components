...
{
    [Header("Refs")] [SerializeField] private TelegraphProgressController controller;
    [SerializeField] private SpriteRenderer frameRenderer;
    [SerializeField] private SpriteRenderer fillRenderer;

    [Header("Sizing")] [Tooltip("Final size of the telegraph zone in local space (world scale).")]
    ...
    [Header("Colors")] public Color telegraphColor = Color.white;
    ...
    [Header("Behavior")] public bool hideOnStart = true;
    ...
    private void OnEnable()
    {
        ...
        controller.OnReactionWindowStart += HandleReactionProgress;
        controller.OnReactionWindowEnd += HandleReactionComplete;
    ...
    private void HandleReactionProgress()
    {
        ApplyColors(reactionColor);
    }

    private void HandleReactionComplete()
    {
        ApplyColors(telegraphColor);
    }
